...
namespace WF_imageComparer
{
    ...
    internal static class ConverterImg
    {
        ...
        internal static void MergeImages(Image img1,Image img2,string outputFilePath,
        ...
        internal static void Dispose<T>(this List<T> list) where T : IDisposable
        {
        ...
        internal class ListDisposable<T> : List<T>, IDisposable where T : IDisposable
        {
